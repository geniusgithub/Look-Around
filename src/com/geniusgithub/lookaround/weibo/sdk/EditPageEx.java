...
public class EditPageEx extends FakeActivity implements OnClickListener, TextWatcher, Callback {
	private static final int MSG_PLATFORM_LIST_GOT = 1;
	private HashMap<String, Object> reqData;
	private ShareActivity parent;
	...
	public void setParent(ShareActivity parent) {
		this.parent = parent;
	}
	...
	public void onCreate() {
		...
		new Thread(){
			public void run() {
				...
				UIHandler.sendEmptyMessage(MSG_PLATFORM_LIST_GOT, EditPageEx.this);
			}
		}.start();
	}
